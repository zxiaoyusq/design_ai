...
1. 六个一级标签仅用于导航，不互斥、不计分；最终分类以二级 `style_id` 及其混淆边界为准。
2. 活动风格必须同时满足：硬门槛通过、命中至少 1 个决定锚点、再命中至少 1 个独立辅助证据、未命中硬排除。同一区域或同一物理现象拆成的近义描述只计一次。
...
5. 硬排除只写原子化可见事实；“更主导、更像、更高级”等相对判断只用于同一混淆组的仲裁。
6. 差异锚点不可见、被遮挡或仍可由结构功能解释时，候选只能为 `provisional`；不得用语义字段补足硬门槛。
7. 活动风格只输出一个主风格；次风格也必须独立通过自身硬门槛。停用标签不得作为新结果输出。
...
| parent_style_id | 显示标签 | 作用 |
| --- | --- | --- |
| restrained_craft | 克制与精工 | 克制构成、温润秩序与精密表面 |
| material_ornament | 材质与华饰 | 金属、深色厚重表面与装饰密度 |
| technology_future | 科技与未来 | 流体单体、机械、发光与算法结构 |
| motion_utility | 动势与机能 | 运动方向、防护体量与实用结构 |
| nature_organic | 自然与有机 | 仿生构形、自然表面与粗粝对照 |
| color_graphic_culture | 色彩/图形与文化 | 色彩机制、平面图形、工艺纹饰与身份图形 |

## 风格注册表

`style_id` 为稳定机器标识；显示标签可以演进，旧名称保存在 `aliases`。`QuietElegantLuxury` 仅供历史迁移，不计入 31 个活动标签。

| style_id | status | parent_style_id | display_name_en | display_name_zh | aliases | replaced_by |
| --- | --- | --- | --- | --- | --- | --- |
| PureMinimalism | active | restrained_craft | Pure Minimalism | 纯粹极简 | — | — |
| NordicCalm | active | restrained_craft | Warm Calm | 温润静雅 | Nordic Calm、静雅北欧 | — |
| RefinedMinimalism | active | restrained_craft | Refined Restraint | 精致克制 | Refined Minimalism、现代简致、静奢简雅 | — |
| PrecisionMinimalism | active | restrained_craft | Precision Order | 精密秩序 | 精工极简 | — |
| SoftContemporary | active | restrained_craft | Soft Pastel | 柔和粉彩 | 柔感当代、SoftPastel | — |
| ModernPrestige | active | material_ornament | Warm Metal Luxury | 暖金精奢 | 现代轻奢 | — |
| QuietElegantLuxury | deprecated | material_ornament | Quiet Elegant Luxury | 静奢简雅 | — | RefinedMinimalism |
| ClassicPrestige | active | material_ornament | Classic Pattern | 经典纹样 | 经典尊享 | — |
| DecorativeLuxury | active | material_ornament | Ornate Pattern | 华饰繁纹 | 繁奢装饰 | — |
| MaturePremium | active | material_ornament | Deep Materiality | 深色醇厚 | 成熟醇厚 | — |
| PureFuture | active | technology_future | Fluid Monolith | 流体单体 | 纯净未来、FluidMonolith | — |
| MechanicalTech | active | technology_future | Exposed Mechanics | 外露机械 | 机械科技 | — |
| CyberNeon | active | technology_future | Neon Interface | 霓虹界面 | Cyber Neon、赛博霓虹、NeonInterface | — |
| ArcaneFuture | active | technology_future | Techno-Mysticism | 科技秘仪 | 神秘未来 | — |
| ParametricTech | active | technology_future | Algorithmic Relief | 算法浮雕 | 参数化科技、AlgorithmicRelief | — |
| TechComposition | active | technology_future | Technical Graphics | 技术图形 | Tech Composition、科技构成、TechnicalGraphics | — |
| KineticEnergy | active | motion_utility | Kinetic Energy | 动感能量 | — | — |
| ArmorPower | active | motion_utility | Armored Massing | 装甲体量 | 重甲力量、ArmoredMassing | — |
| FunctionalAesthetics | active | motion_utility | Rugged Utility | 强韧机能 | Functional Aesthetics、功能美学、RuggedUtility | — |
| NaturalTextures | active | nature_organic | Natural Surface | 自然表面 | Natural Textures、自然肌理、NaturalSurface | — |
| BiomorphicForm | active | nature_organic | Biomorphic Form | 仿生形态 | — | — |
| MysticOrganic | active | nature_organic | Dark Organic | 幽暗有机 | 秘境自然 | — |
| RefinedWilderness | active | nature_organic | Raw Refinement | 粗粝精工 | 精致荒野、RawRefinement | — |
| FreshJoy | active | color_graphic_culture | Fresh Joy | 清新愉悦 | — | — |
| SaturatedBold | active | color_graphic_culture | Saturated Bold | 个性鲜彩 | — | — |
| DreamyAir | active | color_graphic_culture | Dreamy Air | 柔雾幻彩 | — | — |
| Y2KDigital | active | color_graphic_culture | Iridescent Optics | 虹彩光学 | 千禧幻彩、IridescentOptics | — |
| FashionGraphic | active | color_graphic_culture | Geometric Color Blocking | 几何色块 | 时尚构成、GeometricColorBlocking | — |
| NeoRetro | active | color_graphic_culture | Retro Recomposition | 复古重组 | Neo-Retro、Neo Retro、Modern Retro、摩登复古 | — |
| FolkOrnament | active | color_graphic_culture | Craft Ornament | 工艺纹饰 | Folk Ornament、民艺纹饰、CraftOrnament | — |
| ExpressiveMotifs | active | color_graphic_culture | Statement Graphic | 主张图形 | Expressive Motifs、个性潮纹、StatementGraphic | — |
| TribeIdentity | active | color_graphic_culture | Recognized Identity | 可识别身份标识 | 圈层认同、RecognizedIdentity | — |
...
| CG-03 | PrecisionMinimalism、MechanicalTech、ParametricTech、TechComposition、FunctionalAesthetics、ArmorPower | 结构、分区、阵列或部件感 | 冷金属封闭秩序→Precision；外露连接→Mechanical；连续参数变化→Parametric；信息图形系统→Tech；操作/防护结构→Functional；夸张装甲体量→Armor |
| CG-04 | PureFuture、CyberNeon、ArcaneFuture、DreamyAir、Y2KDigital、MysticOrganic | 未来感、发光或光学表面 | 连续流体单体→PureFuture；主动发光界面→Cyber；秘仪符号+异常光层→Arcane；低对比柔雾光学→Dreamy；强虹彩被动反射→Y2K；有机基础+异常光层→Mystic |
| CG-05 | KineticEnergy、SaturatedBold、FashionGraphic | 强冲击、运动色或对比色 | 可确认运动锚点→Kinetic；色彩本身主导且无运动锚点→Saturated；几何色块分区→Fashion |
| CG-06 | NaturalTextures、BiomorphicForm、MysticOrganic、RefinedWilderness | 自然、有机或粗粝感 | 自然纹理→Natural；生长式轮廓→Biomorphic；有机基础+非自然幽暗锚点→Mystic；精确几何×粗粝表面对照→RefinedWilderness |
| CG-07 | ClassicPrestige、DecorativeLuxury、FolkOrnament、ExpressiveMotifs、TribeIdentity、FashionGraphic | 纹样、符号或高信息装饰 | 经典重复纹样→Classic；高密度华饰→Decorative；工艺化纹饰→Folk；表达型大图→Expressive；经确认身份图形→Tribe；抽象几何色块→Fashion |
| CG-08 | NeoRetro、MaturePremium、ClassicPrestige | 深色、皮革感、五金或怀旧线索 | 集成低噪基体+表达性复古语法→NeoRetro；深色厚重表面→Mature；经典重复纹样/镶边→Classic |

## 活动风格规则

以下“异混淆特征”依次写共享表象、决定性差异和差异不可见时的降级方式。
...
| 硬排除 | 可辨装饰图案；非必要异材分割；加大装饰体；主动发光或强光学表面。 |
| 混淆组 | CG-01 |
...
| 硬排除 | 高饱和荧光；暖金属主视觉；主动发光；强虹彩；明显粉蜡主色。 |
| 混淆组 | CG-01 |
| 异混淆特征 | 共享：与柔和粉彩、清新愉悦均可浅色；分界：本类需温润材质/柔雾辅助，不只看色值；不可判时：材质与表面不清则降级。 |
...
| 硬排除 | 高密度装饰；强图案；金属覆盖成为主体；机械连接外露；高饱和主色。 |
| 混淆组 | CG-01、CG-02 |
| 异混淆特征 | 共享：与纯粹极简同样克制、与精密秩序同样精致；分界：本类有小面积设计增量但无冷金属主体；不可判时：增量是否为必要结构不清则降级。 |
...
| 硬排除 | 外露紧固或传动结构；暖金属主体；自然纹理；仅局部金属点缀。 |
| 混淆组 | CG-02、CG-03 |
...
| 决定锚点 | 高明度低彩度粉蜡色；柔化几何。 |
| 辅助证据 | 圆润轮廓；细腻哑光；平衡留白。 |
| 硬排除 | 无彩主色；米白/浅木家居色；中彩果冻色；高饱和色；可见虹彩或空气渐变。 |
| 混淆组 | CG-01 |
...
| 硬排除 | 冷银/钢灰金属主体；无可见暖金属；粗粝主表面；高密度纹样。 |
| 混淆组 | CG-02 |
...
| 硬排除 | 无纹样且无镶边/压纹；纯几何色块；IP角色焦点；随机高密度华饰。 |
| 混淆组 | CG-07、CG-08 |
| 异混淆特征 | 共享：与华饰繁纹、复古重组都可复杂；分界：本类以规则经典重复或镶边为锚点，不要求已知品牌；不可判时：纹样结构不可辨则降级。 |
...
| 硬排除 | 装饰仅占孤立小区域且主体大面积无图案；技术信息图形；抽象几何色块；可确认IP角色焦点。 |
| 混淆组 | CG-07 |
...
| 辅助证据 | 克制五金；较实体量；细密纹理。 |
| 硬排除 | 明快浅色主视觉；荧光冲击；主动发光；只有深色但表面平薄无厚重线索。 |
| 混淆组 | CG-02、CG-08 |
| 异混淆特征 | 共享：与复古重组、经典纹样都可深色；分界：本类靠厚重表面，不要求怀旧语法或重复纹样；不可判时：表面深度不清则降级。 |
...
| 硬排除 | 外露紧固结构；复古五金；高密度机械分件；粗糙自然表面。 |
| 混淆组 | CG-04 |
| 异混淆特征 | 共享：与霓虹界面、虹彩光学均有未来光泽；分界：本类锚点是连续单体形态，不依赖主动光或虹彩膜；不可判时：曲面连续性被遮挡则降级。 |
...
| 混淆组 | CG-03 |
| 异混淆特征 | 共享：与算法浮雕、技术图形、强韧机能都有结构感；分界：本类必须能读出连接与机械层级；不可判时：部件功能或连接不可辨则降级。 |
...
| 硬排除 | 只有暗色与戏剧灯光；纯自然纹理；普通技术刻度；可读常规界面。 |
| 混淆组 | CG-04 |
| 异混淆特征 | 共享：与霓虹界面、幽暗有机都可暗且发光；分界：本类必须有人造秘仪符号，常规UI转霓虹界面；不可判时：符号性质不清则降级。 |
...
| 硬排除 | 完全均匀孔阵；仅平面网格；仅握持防滑阵列；随机自然纹理。 |
| 混淆组 | CG-03 |
...
| 硬排除 | 只有三维参数浮雕；只有机械连接；纯几何色块；孤立Logo或装饰文字。 |
| 混淆组 | CG-03 |
...
| 混淆组 | CG-05 |
| 异混淆特征 | 共享：与个性鲜彩都可高饱和、与流体单体都可流线；分界：本类必须由物体本体的姿态/速度图形/性能构件建立方向性；不可判时：线条仍可解释为结构边界则降级。 |
...
| 混淆组 | CG-03 |
| 异混淆特征 | 共享：与装甲体量、外露机械都有强结构；分界：本类结构能对应操作、防护或挂载，非必要体量转装甲；不可判时：用途不可辨则降级。 |
...
| 混淆组 | CG-06 |
| 异混淆特征 | 共享：与仿生形态、粗粝精工都有自然感；分界：本类锚点在表面纹理，不要求有机轮廓或精确几何对照；不可判时：纹理属于主体还是背景不清则降级。 |
...
| 混淆组 | CG-06 |
| 异混淆特征 | 共享：与自然表面、流体单体及圆润器物都有曲线；分界：本类必须有非功能性生长/细胞拓扑，常规泡罩与包覆壳不计；不可判时降级。 |
...
| 硬排除 | 只有暗色摄影；人工仪式符号与异常光层成组出现；普通自然纹理无异常层；常规主动UI光。 |
| 混淆组 | CG-04、CG-06 |
| 异混淆特征 | 共享：与自然表面、科技秘仪都可幽暗；分界：本类先有有机证据且无人工秘仪系统；不可判时：异常光是否来自背景不清则降级。 |
...
| 混淆组 | CG-06 |
| 异混淆特征 | 共享：与自然表面、精密秩序都有材质表达；分界：本类必须同时存在精确与粗粝的可见对照；不可判时：粗面是否为损伤不清则降级。 |
...
| 硬排除 | 低彩粉蜡色；高饱和荧光；强虹彩；异色云雾渐变；几何色块分区。 |
| 混淆组 | CG-01 |
...
| 硬门槛 | 高饱和/荧光主色占主要面积，且无需运动锚点或复杂图案即可成立。 |
| 决定锚点 | 大面积高饱和实色；简单高对比撞色。 |
| 辅助证据 | 少量中性色功能件；清晰色边界；高色纯度。 |
| 硬排除 | 已确认运动锚点；大面积图案/涂鸦；几何多分区；异色光学渐变；中彩果冻色。 |
| 混淆组 | CG-05 |
| 异混淆特征 | 共享：与动感能量都有强冲击；分界：本类由色彩本身成立且缺少运动锚点，功能接缝、透明区和小金属件不改变判断；不可判时：疑似速度线仍可解释为结构边界则保留本类候选并降级。 |
...
| 硬排除 | 高对比镭射/全息反射；主动发光界面；明快实色；连续银白流体曲面与悬浮层同时出现。 |
| 混淆组 | CG-04 |
...
| 硬排除 | 主动LED/霓虹；低对比柔雾珠光；只有彩色实色；仅拍摄色散。 |
| 混淆组 | CG-04 |
...
| 硬排除 | 三维参数浮雕；功能/机械分区；具象插画焦点；已确认IP图形。 |
| 混淆组 | CG-05、CG-07 |
| 异混淆特征 | 共享：与个性鲜彩、技术图形、主张图形都有强平面视觉；分界：本类由抽象色块版式成立，不靠文字信息或具象内容；不可判时：分区是否为结构件不清则降级。 |
...
| 硬门槛 | 集成低噪基体成立，并命中至少两类独立复古线索；其中至少一类不能由品类基本功能或结构边界解释。 |
| 决定锚点 | 集成低噪基体×表达性复古五金/包边；异质表面视觉并置。 |
| 辅助证据 | 黄铜视觉；经典旋钮；皮革/麂皮候选；复古双色。 |
| 硬排除 | 只有怀旧色、滤镜或磨损；纯经典重复纹样；线索均为未造型化的通用功能件或结构边界。 |
| 混淆组 | CG-08 |
| 异混淆特征 | 共享：与深色醇厚、经典纹样都可用皮革感和五金；分界：本类靠可见的新旧语法重组，不靠真实年代；不可判时：线索是否仅为基本功能件不清则降级。 |
...
| 硬排除 | 纯平面工业印刷且无工艺视觉；只有文化联想；可确认IP角色；抽象几何色块。 |
| 混淆组 | CG-07 |
...
| 硬排除 | 纯抽象几何色块；工艺纹饰结构；经确认IP/联名身份图形；无图案纯色。 |
| 混淆组 | CG-07 |
| 异混淆特征 | 共享：与身份标识、几何色块都可图形醒目；分界：本类强调表达内容但无已确认归属，身份被确认则转Tribe；不可判时：图形来源未知仍可判本类但不得声称原创。 |
| 典型视觉Token | statement_graphic、large_typography、illustration_focus、expressive_symbol |

### TribeIdentity — 可识别身份标识

| 字段 | 内容 |
| --- | --- |
| 核心机制 | 以可被可靠识别的IP、联名锁定组合或社群标识建立身份指向。 |
| 颜色角色 | unrestricted |
| 硬门槛 | 高显性名称、角色或锁定组合成为焦点，且身份由完整可读的画面自标识或批准参考库确认；普通Logo不够。 |
| 决定锚点 | 可确认IP/角色；联名双方锁定组合；明确社群徽章。 |
| 辅助证据 | 官方角色配色；系列化标识；重复身份符号。 |
| 硬排除 | 来源未知的插画/涂鸦；普通单一Logo；地域工艺纹饰；既无完整可读自标识也无批准参考。 |
| 混淆组 | CG-07 |
| 异混淆特征 | 共享：与主张图形都可有角色、文字或符号；分界：完整自标识只确认画面呈现的视觉身份，外部实体仍需参考库；不可判时：无自标识或参考则归主张图形或 provisional。 |
| 典型视觉Token | recognized_ip、collaboration_lockup、community_badge、identity_graphic |
...
| 模块 | 数量 | 范围 |
| --- | ---: | --- |
| M01 GEO | 13 | 比例、体量、姿态与接地 |
| M02 FORM | 14 | 轮廓、曲面与边界 |
| M03 CMP | 14 | 构图、层级与动势 |
| M04 PRT | 13 | 组件、父子关系、开口与负空间 |
...
| M15 REL | 8 | 参考集计算关系 |
| **合计** | **183** | 不含 legacy_alias 与拍摄质量元数据 |
...
| IMG-01、IMG-02 | style_result.primary_style、style_result.secondary_styles | 移入 style_result（非字段 alias/compatibility_derived） |
